...
client = Cloudant.iam("8cf4e064-9297-40d3-a249-fe2a01a19753-bluemix","xIqUEN25bqaurQsobSCokfwfjnvzutz6vbb8XzkeXIxg",connect=True)
my_database = client.create_database("database-darsh")
